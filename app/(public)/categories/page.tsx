...
export const metadata: Metadata = {
  ...
  description:
    "Browse movies by categories - Action, Comedy, Drama, Horror, Sci-Fi and more",
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground text-lg">
          Discover movies by genre - Browse through our {categories.length}{" "}
          categories
        </p>
      </div>
      ...
      {categories.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <p className="text-muted-foreground">
            There are no categories created yet. Categories will appear here
            once they are added.
          </p>
        </div>
      )}
